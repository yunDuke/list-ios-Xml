...
class dTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        for(var i = 0; i < peopleModel.data.count;i++){
            if peopleModel.data[i].position == "Defender"
            {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "a"{
            ...
            let controller = segue.destinationViewController as! defenseViewController
